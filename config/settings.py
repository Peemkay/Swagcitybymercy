...
MIDDLEWARE = [
    ...
    "pages.middleware.SyncJazzminBrandingMiddleware",
]
...
JAZZMIN_SETTINGS = {
    ...
    "site_logo_classes": "brand-image-icon",
    ...
    "icons": {
        ...
        "orders.OrderEvent": "fas fa-timeline",
        "orders.Refund": "fas fa-money-bill-transfer",
        ...
        "pages.PolicyPage": "fas fa-file-contract",
        "pages.FAQItem": "fas fa-circle-question",
